...
import type { AffirmationCount, AuthorizationType, CappedFee, CddStatus, ComplianceReport, DidStatus, ExecuteInstructionInfo, IdentityClaim, IdentityId, InstructionId, KeyIdentityData, Leg, Member, NFTs, PipId, PortfolioId, ProtocolOp, RpcDidRecords, Signatory, VoteCount } from 'polymesh-types/polymesh';
...
declare module '@polkadot/rpc-core/types/jsonrpc' {
  interface RpcInterface {
    asset: {
       ...
       **/
      transferReport: AugmentedRpc<(senderPortfolio: PortfolioId | { did?: any; kind?: any } | string | Uint8Array, receiverPortfolio: PortfolioId | { did?: any; kind?: any } | string | Uint8Array, assetId: AssetId | string | Uint8Array, transferValue: Balance | AnyNumber | Uint8Array, skipLockedCheck: bool | boolean | Uint8Array, blockHash?: Hash | string | Uint8Array) => Observable<Vec<DispatchError>>>;
    };
    author: {
      /**
    ...
    settlement: {
       ...
       **/
      getAffirmationCount: AugmentedRpc<(instruction_id: InstructionId | AnyNumber | Uint8Array, portfolios: Vec<PortfolioId> | (PortfolioId | { did?: any; kind?: any } | string | Uint8Array)[], blockHash?: Hash | string | Uint8Array) => Observable<AffirmationCount>>;
      /**
       ...
       * Returns a vector containing all errors for the transfer. An empty vec means there's no error.
       **/
      getTransferReport: AugmentedRpc<(leg: Leg | { Fungible: any } | { NonFungible: any } | { OffChain: any } | string | Uint8Array, skip_locked_check: bool | boolean | Uint8Array) => Observable<Vec<DispatchError>>>;
    };
    staking: {
      /**
